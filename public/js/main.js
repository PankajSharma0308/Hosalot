...
$(document).ready(function() {
  ...
  // document.getElementById('hosalot_1').innerHTML = res.locals.user;
  // document.getElementById('hosalot_1').innerHTML = user;
  ...
  $(function() {
	  ...
	  $.get( "/auth", function( data ) {
		  ...
		  sessionStorage.setItem("stud_phone",stud_phone);
